...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 shrink-0 bg-[linear-gradient(180deg,rgba(20,34,56,0.98)_0%,rgba(11,21,39,0.98)_100%)] text-cream-100 flex flex-col h-screen sticky top-0 border-r border-line backdrop-blur-sm">
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    active
                      ? "bg-navy-700/78 text-cream-50 shadow-[inset_0_0_0_1px_rgba(201,216,238,0.08)]"
                      : "text-navy-100 hover:text-cream-50 hover:bg-navy-800/62",
                  )}
                >
      ...
      <div className="px-3 py-4 border-t border-line">
        ...
        <div className="mt-4 px-3 py-3 rounded-lg bg-navy-800/56 border border-line">
