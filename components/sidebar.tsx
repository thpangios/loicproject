...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 shrink-0 bg-navy-700 text-cream-100 flex flex-col h-screen sticky top-0">
      <div className="px-6 pt-7 pb-6 border-b border-navy-600/60">
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    active
                      ? "bg-navy-600 text-cream-50"
                      : "text-navy-100 hover:text-cream-50 hover:bg-navy-600/50",
                  )}
                >
      ...
      <div className="px-3 py-4 border-t border-navy-600/60">
        ...
        <div className="mt-4 px-3 py-3 rounded-lg bg-navy-800/60 border border-navy-600/40">
